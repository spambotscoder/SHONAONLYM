...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("DestinyxMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("DestinyxMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("DestinyxMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("DestinyxMusic/assets/play_icons.png")
