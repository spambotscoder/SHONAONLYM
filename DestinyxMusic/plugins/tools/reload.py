...
from DestinyxMusic.utils.decorators import ActualAdminCB, AdminActual, language
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await destiny.stop_stream_force(message.chat.id)
    except:
        pass
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await destiny.stop_stream_force(chat_id)
        except:
            pass
