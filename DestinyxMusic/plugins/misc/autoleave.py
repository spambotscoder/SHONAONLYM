...
from DestinyxMusic.core.call import destiny, autoend, counter
from DestinyxMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                nocall = False
                try:
                    assistant = await group_assistant(destiny, chat_id)
