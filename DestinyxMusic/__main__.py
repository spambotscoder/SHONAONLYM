...
async def init():
    ...
    LOGGER("DestinyxMusic.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await destiny.start()
    try:
        await destiny.stream_call("https://te.legra.ph/file/29f784eb49d230ab62e9e.mp4")
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("DestinyxMusic").info("Stopping Destiny Music Bot...")
